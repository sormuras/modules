...
- 🧩 188 (18.8%) Java modules (module descriptor with stable name and API)
- ⬜ 270 (27.0%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 404 (40.4%) Automatic Java modules (name derived from JAR filename)
- ➖ 138 (13.8%) Unrelated artifacts (BOM, POM, ... or not recently updated)
