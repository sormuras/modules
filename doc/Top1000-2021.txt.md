...
- ⬜ 280 (28.0%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 431 (43.1%) Automatic Java modules (name derived from JAR filename)
- ➖ 144 (14.4%) Unrelated artifacts (BOM, POM, ... or not recently updated)
