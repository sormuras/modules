...
- 🧩 139 (13.9%) Java modules (module descriptor with stable name and API)
- ⬜ 271 (27.1%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 444 (44.4%) Automatic Java modules (name derived from JAR filename)
- ➖ 146 (14.6%) Unrelated artifacts (BOM, POM, ... or not recently updated)
