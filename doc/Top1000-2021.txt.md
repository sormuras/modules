...
- 🧩 141 (14.1%) Java modules (module descriptor with stable name and API)
- ⬜ 276 (27.6%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 437 (43.7%) Automatic Java modules (name derived from JAR filename)
