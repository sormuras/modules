...
- 🧩 204 (20.4%) Java modules (module descriptor with stable name and API)
- ⬜ 311 (31.1%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 365 (36.5%) Automatic Java modules (name derived from JAR filename)
- ➖ 120 (12.0%) Unrelated artifacts (BOM, POM, ... or not recently updated)
