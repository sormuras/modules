...
- ⬜ 257 (25.7%) Automatic Java modules (name derived from JAR manifest)
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-core` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:jmespath-java` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-kms` | 1.11.964 |
...
| ⬜ | `com.github.luben.zstd_jni` | `com.github.luben:zstd-jni` | 1.4.8-6 |
...
| ⚪ |  | `org.antlr:ST4` | 4.3.1 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-sts` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-dynamodb` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-sns` | 1.11.964 |
...
| ⬜ | `org.apache.thrift` | `org.apache.thrift:libthrift` | 0.14.0 |
| ⚪ |  | `io.springfox:springfox-swagger-ui` | 3.0.0 |
| ⚪ |  | `com.amazonaws:aws-java-sdk` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-ec2` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-kinesis` | 1.11.964 |
| ⚪ |  | `jaxen:jaxen` | 1.2.0 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudwatch` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-ssm` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-autoscaling` | 1.11.964 |
| ⬜ | `spring.webflux` | `org.springframework:spring-webflux` | 5.3.4 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-ses` | 1.11.964 |
| ⚪ |  | `org.parboiled:parboiled-core` | 1.3.1 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudformation` | 1.11.964 |
...
| ⬜ | `software.amazon.awssdk.annotations` | `software.amazon.awssdk:annotations` | 2.16.8 |
| ⬜ | `software.amazon.awssdk.http` | `software.amazon.awssdk:http-client-spi` | 2.16.8 |
...
| ⬜ | `software.amazon.awssdk.utils` | `software.amazon.awssdk:utils` | 2.16.8 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-lambda` | 1.11.964 |
...
| ⬜ | `software.amazon.awssdk.core` | `software.amazon.awssdk:sdk-core` | 2.16.8 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-secretsmanager` | 1.11.964 |
| 🧩 | `org.apache.tomcat.juli` | `org.apache.tomcat:tomcat-juli` | **10.0.2** |
| ⚪ |  | `io.opencensus:opencensus-contrib-grpc-metrics` | 0.28.3 |
| ⬜ | `software.amazon.awssdk.regions` | `software.amazon.awssdk:regions` | 2.16.8 |
| ⬜ | `brave` | `io.zipkin.brave:brave` | 5.13.3 |
| ⚪ |  | `com.google.re2j:re2j` | 1.5 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-iam` | 1.11.964 |
| ⚪ |  | `org.scala-sbt:util-scripted_2.12` | 1.5.0-M2 |
| ⚪ |  | `org.apache.maven.wagon:wagon-ssh` | 3.4.3 |
| ⬜ | `software.amazon.awssdk.auth` | `software.amazon.awssdk:auth` | 2.16.8 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-rds` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-logs` | 1.11.964 |
| ⚪ |  | `org.elasticsearch:elasticsearch` | 7.11.1 |
| ⬜ | `io.opentracing.api` | `io.opentracing:opentracing-api` | 0.33.0 |
| ⬜ | `software.amazon.awssdk.awscore` | `software.amazon.awssdk:aws-core` | 2.16.8 |
...
| ⬜ | `software.amazon.awssdk.protocols.core` | `software.amazon.awssdk:protocol-core` | 2.16.8 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-route53` | 1.11.964 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-simpleworkflow` | 1.11.964 |
...
| ⬜ | `software.amazon.awssdk.profiles` | `software.amazon.awssdk:profiles` | 2.16.8 |
...
| ⬜ | `software.amazon.awssdk.http.apache` | `software.amazon.awssdk:apache-client` | 2.16.8 |
...
| ⬜ | `software.amazon.awssdk.http.nio.netty` | `software.amazon.awssdk:netty-nio-client` | 2.16.8 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-elasticloadbalancing` | 1.11.964 |
...
| ⚪ |  | `org.json4s:json4s-scalap_2.12` | 3.7.0-M9 |
| ⚪ |  | `com.google.auto:auto-common` | 0.11 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-emr` | 1.11.964 |
| ⚪ |  | `org.json4s:json4s-ast_2.12` | 3.7.0-M9 |
| ⚪ |  | `org.json4s:json4s-core_2.12` | 3.7.0-M9 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-cognitoidentity` | 1.11.964 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-elasticbeanstalk` | 1.11.964 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-xray` | 1.11.964 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudfront` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-ecs` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudwatchmetrics` | 1.11.964 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-elasticache` | 1.11.964 |
