...
- 🧩 121 (12.1%) Java modules (module descriptor with stable name and API)
- ⬜ 259 (25.9%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 465 (46.5%) Automatic Java modules (name derived from JAR filename)
- ➖ 155 (15.5%) Unrelated artifacts (BOM, POM, ... or not recently updated)
...
| ⬜ | `io.netty.tcnative.boringssl` | `io.netty:netty-tcnative-boringssl-static` |
