...
- 🧩 125 (12.5%) Java modules (module descriptor with stable name and API)
...
- ➖ 151 (15.1%) Unrelated artifacts (BOM, POM, ... or not recently updated)
...
| ⬜ | `io.netty.tcnative.openssl.osx-x86_64` | `io.netty:netty-tcnative-boringssl-static` |
