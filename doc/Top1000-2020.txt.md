...
- ⬜ 258 (25.8%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 452 (45.2%) Automatic Java modules (name derived from JAR filename)
- ➖ 149 (14.9%) Unrelated artifacts (BOM, POM, ... or not recently updated)
