...
- 🧩 115 (11.5%) Java modules (module descriptor with stable name and API)
- ⬜ 256 (25.6%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 473 (47.3%) Automatic Java modules (name derived from JAR filename)
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-core` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:jmespath-java` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-s3` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-kms` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-sqs` | 1.11.962 |
...
| ⚪ |  | `org.antlr:ST4` | 4.3.1 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-sts` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-dynamodb` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-sns` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk` | 1.11.962 |
...
| ⬜ | `com.github.spotbugs.annotations` | `com.github.spotbugs:spotbugs-annotations` | 4.2.1 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-ec2` | 1.11.962 |
...
| ⚪ |  | `com.google.api:gax-httpjson` | 0.78.0 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-kinesis` | 1.11.962 |
| ⚪ |  | `jaxen:jaxen` | 1.2.0 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudwatch` | 1.11.962 |
...
| ⬜ | `com.microsoft.sqlserver.jdbc` | `com.microsoft.sqlserver:mssql-jdbc` | 9.2.0.jre15 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-ssm` | 1.11.962 |
| ⬜ | `com.google.api.services.storage` | `com.google.apis:google-api-services-storage` | v1-rev20210127-1.31.0 |
...
| ⚪ |  | `org.jetbrains.kotlin:kotlin-scripting-jvm` | 1.4.30 |
| ⚪ |  | `org.liquibase:liquibase-core` | 4.3.1 |
| 🧩 | `org.slf4j.nop` | `org.slf4j:slf4j-nop` | **2.0.0-alpha1** |
| ⚪ |  | `com.amazonaws:aws-java-sdk-autoscaling` | 1.11.962 |
| ⬜ | `spring.webflux` | `org.springframework:spring-webflux` | 5.3.4 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-ses` | 1.11.962 |
| ⚪ |  | `org.parboiled:parboiled-core` | 1.3.1 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudformation` | 1.11.962 |
...
| ⬜ | `org.eclipse.jetty.websocket.server` | `org.eclipse.jetty.websocket:websocket-server` | 9.4.37.v20210219 |
...
| 🧩 | `com.google.gson` | `org.jetbrains.kotlin:kotlin-gradle-plugin` | 1.4.30 |
| ⚪ |  | `org.jetbrains.kotlin:kotlin-scripting-compiler-embeddable` | 1.4.30 |
| ⚪ |  | `org.jetbrains.kotlin:kotlin-android-extensions` | 1.4.30 |
...
| ⚪ |  | `org.jetbrains.kotlin:kotlin-gradle-plugin-api` | 1.4.30 |
| ⚪ |  | `com.typesafe.scala-logging:scala-logging_2.12` | 3.9.2 |
| 🧩 | `com.fasterxml.jackson.module.afterburner` | `com.fasterxml.jackson.module:jackson-module-afterburner` | **2.12.1** |
| ⚪ |  | `org.jetbrains.kotlin:kotlin-annotation-processing-gradle` | 1.4.30 |
...
| ⬜ | `software.amazon.awssdk.annotations` | `software.amazon.awssdk:annotations` | 2.16.6 |
| ⬜ | `software.amazon.awssdk.http` | `software.amazon.awssdk:http-client-spi` | 2.16.6 |
| ⚪ |  | `com.nimbusds:oauth2-oidc-sdk` | 9.2 |
...
| ⚪ |  | `org.jetbrains.kotlin:kotlin-compiler-runner` | 1.4.30 |
...
| ⚪ |  | `org.jetbrains.kotlin:kotlin-daemon-client` | 1.4.30 |
| ⬜ | `software.amazon.awssdk.utils` | `software.amazon.awssdk:utils` | 2.16.6 |
| ⚪ |  | `org.apache.hive.shims:hive-shims-common` | 3.1.2 |
| ⚪ |  | `org.jetbrains.kotlin:kotlin-build-common` | 1.4.30 |
...
| ⚪ |  | `org.jetbrains.kotlin:kotlin-gradle-plugin-model` | 1.4.30 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-lambda` | 1.11.962 |
...
| ⚪ |  | `org.jetbrains.kotlin:kotlin-daemon-embeddable` | 1.4.30 |
| ⚪ |  | `com.github.java-json-tools:json-schema-validator` | 2.2.14 |
| ⚪ |  | `org.jetbrains.kotlin:kotlin-util-io` | 1.4.30 |
...
| ⬜ | `software.amazon.awssdk.core` | `software.amazon.awssdk:sdk-core` | 2.16.6 |
| ⚪ |  | `com.google.cloud:google-cloud-core-grpc` | 1.94.1 |
| ⬜ | `org.datanucleus` | `org.datanucleus:datanucleus-core` | 5.2.6 |
| ⬜ | `zipkin2.reporter` | `io.zipkin.reporter2:zipkin-reporter` | 2.16.3 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-secretsmanager` | 1.11.962 |
| 🧩 | `org.apache.tomcat.juli` | `org.apache.tomcat:tomcat-juli` | **10.0.2** |
| ⚪ |  | `io.opencensus:opencensus-contrib-grpc-metrics` | 0.28.3 |
| ⬜ | `software.amazon.awssdk.regions` | `software.amazon.awssdk:regions` | 2.16.6 |
| ⬜ | `brave` | `io.zipkin.brave:brave` | 5.13.3 |
| ⚪ |  | `com.google.re2j:re2j` | 1.5 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-iam` | 1.11.962 |
| ⚪ |  | `org.scala-sbt:util-scripted_2.12` | 1.5.0-M2 |
| ⚪ |  | `org.apache.maven.wagon:wagon-ssh` | 3.4.3 |
| ⬜ | `software.amazon.awssdk.auth` | `software.amazon.awssdk:auth` | 2.16.6 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-rds` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-logs` | 1.11.962 |
| ⚪ |  | `org.elasticsearch:elasticsearch` | 7.11.1 |
| ⬜ | `io.opentracing.api` | `io.opentracing:opentracing-api` | 0.33.0 |
| ⬜ | `software.amazon.awssdk.awscore` | `software.amazon.awssdk:aws-core` | 2.16.6 |
...
| ⬜ | `software.amazon.awssdk.protocols.core` | `software.amazon.awssdk:protocol-core` | 2.16.6 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-route53` | 1.11.962 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-simpleworkflow` | 1.11.962 |
...
| ⬜ | `software.amazon.awssdk.profiles` | `software.amazon.awssdk:profiles` | 2.16.6 |
...
| ⬜ | `software.amazon.awssdk.http.apache` | `software.amazon.awssdk:apache-client` | 2.16.6 |
...
| ⬜ | `software.amazon.awssdk.http.nio.netty` | `software.amazon.awssdk:netty-nio-client` | 2.16.6 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-elasticloadbalancing` | 1.11.962 |
| ⬜ | `org.apache.bcel` | `org.apache.bcel:bcel` | 6.5.0 |
| ⚪ |  | `org.jetbrains.intellij.deps:trove4j` | 1.0.20200330 |
| ⚪ |  | `org.jetbrains.kotlin:kotlin-scripting-compiler-impl-embeddable` | 1.4.30 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-emr` | 1.11.962 |
| ⚪ |  | `org.json4s:json4s-ast_2.12` | 3.7.0-M8 |
| ⚪ |  | `org.json4s:json4s-core_2.12` | 3.7.0-M8 |
| ⚪ |  | `org.jetbrains.kotlin:kotlin-maven-plugin` | 1.4.30 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-cognitoidentity` | 1.11.962 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-elasticbeanstalk` | 1.11.962 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-xray` | 1.11.962 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudfront` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-ecs` | 1.11.962 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudwatchmetrics` | 1.11.962 |
| ⚪ |  | `org.jetbrains.kotlin:kotlin-util-klib` | 1.4.30 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-elasticache` | 1.11.962 |
