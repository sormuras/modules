...
- ⬜ 300 (30.0%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 423 (42.3%) Automatic Java modules (name derived from JAR filename)
- ➖ 133 (13.3%) Unrelated artifacts (BOM, POM, ... or not recently updated)
...
| 🧩 | `com.fasterxml.jackson.databind` | `net.snowflake:snowflake-jdbc` |
