...
- 🧩 168 (16.8%) Java modules (module descriptor with stable name and API)
- ⬜ 311 (31.1%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 392 (39.2%) Automatic Java modules (name derived from JAR filename)
