...
- 🧩 165 (16.5%) Java modules (module descriptor with stable name and API)
- ⬜ 312 (31.2%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 393 (39.3%) Automatic Java modules (name derived from JAR filename)
- ➖ 130 (13.0%) Unrelated artifacts (BOM, POM, ... or not recently updated)
...
| 🧩 | `org.bouncycastle.pkix` | `net.snowflake:snowflake-jdbc` |
