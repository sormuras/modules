...
- 🧩 154 (15.4%) Java modules (module descriptor with stable name and API)
- ⬜ 319 (31.9%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 396 (39.6%) Automatic Java modules (name derived from JAR filename)
