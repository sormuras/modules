...
- 🧩 151 (15.1%) Java modules (module descriptor with stable name and API)
- ⬜ 306 (30.6%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 412 (41.2%) Automatic Java modules (name derived from JAR filename)
- ➖ 131 (13.1%) Unrelated artifacts (BOM, POM, ... or not recently updated)
...
| 🧩 | `com.fasterxml.jackson.dataformat.cbor` | `net.snowflake:snowflake-jdbc` |
...
| ⬜ | `io.netty.resolver.dns.macos.osx.x86_64` | `io.netty:netty-resolver-dns-native-macos` |
...
| 🧩 | `com.fasterxml.jackson.core` | `software.amazon.awssdk:third-party-jackson-core` |
