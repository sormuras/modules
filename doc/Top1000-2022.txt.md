...
- 🧩 150 (15.0%) Java modules (module descriptor with stable name and API)
- ⬜ 305 (30.5%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 414 (41.4%) Automatic Java modules (name derived from JAR filename)
...
| ⬜ | `org.apache.logging.slf4j` | `org.apache.logging.log4j:log4j-to-slf4j` |
