...
- 🧩 128 (12.8%) Java modules (module descriptor with stable name and API)
- ⬜ 214 (21.4%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 311 (31.1%) Automatic Java modules (name derived from JAR filename)
