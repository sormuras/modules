...
- ⬜ 204 (20.4%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 339 (33.9%) Automatic Java modules (name derived from JAR filename)
...
| ⬜ | `software.amazon.awssdk.protocols.query` | `software.amazon.awssdk:aws-query-protocol` | 2.16.10 |
...
| ⬜ | `software.amazon.awssdk.protocols.json` | `software.amazon.awssdk:aws-json-protocol` | 2.16.10 |
