...
- 🧩 131 (13.1%) Java modules (module descriptor with stable name and API)
- ⬜ 212 (21.2%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 310 (31.0%) Automatic Java modules (name derived from JAR filename)
