...
- 🧩 124 (12.4%) Java modules (module descriptor with stable name and API)
- ⬜ 206 (20.6%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 321 (32.1%) Automatic Java modules (name derived from JAR filename)
- ➖ 349 (34.9%) Unrelated artifacts (BOM, POM, ... or not recently updated)
