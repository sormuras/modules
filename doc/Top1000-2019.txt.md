...
- 🧩 102 (10,2%) Java modules (module descriptor with stable name and API)
- ⬜ 201 (20,1%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 341 (34,1%) Automatic Java modules (name derived from JAR filename)
- ➖ 356 (35,6%) Unknown artifacts (BOM, POM, ... or not recently updated)
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-core` | 1.11.942 |
...
| ⚪ |  | `com.amazonaws:jmespath-java` | 1.11.942 |
...
| 🧩 | `com.zaxxer.hikari` | `com.zaxxer:HikariCP` | **4.0.0** |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-s3` | 1.11.942 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-kms` | 1.11.942 |
...
| ⚪ |  | `org.springframework.security:spring-security-bom` | 5.4.2 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-sqs` | 1.11.942 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-dynamodb` | 1.11.942 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-sts` | 1.11.942 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudwatch` | 1.11.942 |
| ⬜ | `com.codahale.metrics.jvm` | `io.dropwizard.metrics:metrics-jvm` | 4.2.0-beta.1 |
| ⚪ |  | `com.lihaoyi:fastparse_2.12` | 2.3.0 |
| ⬜ | `com.google.auth` | `com.google.auth:google-auth-library-credentials` | 0.22.2 |
| ⚪ |  | `com.sun.jersey:jersey-json` | 1.19.4 |
| ⚪ |  | `com.sun.jersey:jersey-server` | 1.19.4 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-kinesis` | 1.11.942 |
...
| ⬜ | `com.google.auth.oauth2` | `com.google.auth:google-auth-library-oauth2-http` | 0.22.2 |
...
| ⬜ | `software.amazon.awssdk.annotations` | `software.amazon.awssdk:annotations` | 2.15.69 |
| ⚪ |  | `org.apache.maven.enforcer:enforcer-api` | 3.0.0-M3 |
| ⬜ | `software.amazon.awssdk.utils` | `software.amazon.awssdk:utils` | 2.15.69 |
| ⚪ |  | `org.apache.maven.enforcer:enforcer-rules` | 3.0.0-M3 |
| ⚪ |  | `org.jetbrains.kotlin:kotlin-script-runtime` | 1.4.30-RC |
| ⬜ | `software.amazon.awssdk.http` | `software.amazon.awssdk:http-client-spi` | 2.15.69 |
...
| ⬜ | `software.amazon.awssdk.core` | `software.amazon.awssdk:sdk-core` | 2.15.69 |
...
| ⬜ | `software.amazon.awssdk.regions` | `software.amazon.awssdk:regions` | 2.15.69 |
| ⚪ |  | `org.scala-lang.modules:scala-java8-compat_2.12` | 0.9.1 |
| ⚪ |  | `jaxen:jaxen` | 1.2.0 |
| ⚪ |  | `com.trueaccord.scalapb:scalapb-runtime_2.12` | 0.6.7 |
| ⬜ | `software.amazon.awssdk.auth` | `software.amazon.awssdk:auth` | 2.15.69 |
| ⚪ |  | `com.trueaccord.lenses:lenses_2.12` | 0.4.12 |
| 🧩 | `com.fasterxml.jackson.module.paranamer` | `com.fasterxml.jackson.module:jackson-module-paranamer` | **2.12.1** |
| ⬜ | `software.amazon.awssdk.awscore` | `software.amazon.awssdk:aws-core` | 2.15.69 |
| ⚪ |  | `org.glassfish.jersey.media:jersey-media-json-jackson` | 3.0.0 |
| ⬜ | `software.amazon.awssdk.http.nio.netty` | `software.amazon.awssdk:netty-nio-client` | 2.15.69 |
| ⬜ | `software.amazon.awssdk.protocols.core` | `software.amazon.awssdk:protocol-core` | 2.15.69 |
...
| ⬜ | `software.amazon.awssdk.http.apache` | `software.amazon.awssdk:apache-client` | 2.15.69 |
...
| ⬜ | `software.amazon.awssdk.profiles` | `software.amazon.awssdk:profiles` | 2.15.69 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-lambda` | 1.11.942 |
...
| ⬜ | `software.amazon.awssdk.protocols.query` | `software.amazon.awssdk:aws-query-protocol` | 2.15.69 |
| ⚪ |  | `org.apache.tomcat:tomcat-jdbc` | 10.0.0 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudformation` | 1.11.942 |
...
| ⬜ | `software.amazon.awssdk.protocols.json` | `software.amazon.awssdk:aws-json-protocol` | 2.15.69 |
...
| ⚪ |  | `com.amazonaws:aws-java-sdk-cloudfront` | 1.11.942 |
| ⬜ | `org.jline` | `org.jline:jline` | 3.19.0 |
| ⚪ |  | `org.hibernate:hibernate-entitymanager` | 5.4.9.Final |
| ⚪ |  | `org.apache.maven.wagon:wagon-webdav-jackrabbit` | 3.4.2 |
| ⚪ |  | `org.glassfish:javax.el` | 3.0.1-b12 |
| ⚪ |  | `cglib:cglib` | 3.3.0 |
| ⚪ |  | `com.amazonaws:aws-java-sdk-route53` | 1.11.942 |
