...
- 🧩 122 (12.2%) Java modules (module descriptor with stable name and API)
- ⬜ 205 (20.5%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 323 (32.3%) Automatic Java modules (name derived from JAR filename)
- ➖ 350 (35.0%) Unrelated artifacts (BOM, POM, ... or not recently updated)
