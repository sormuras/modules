...
- ⬜ 207 (20.7%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 321 (32.1%) Automatic Java modules (name derived from JAR filename)
- ➖ 347 (34.7%) Unrelated artifacts (BOM, POM, ... or not recently updated)
