...
- 🧩 108 (10.8%) Java modules (module descriptor with stable name and API)
- ⬜ 217 (21.7%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 323 (32.3%) Automatic Java modules (name derived from JAR filename)
- ➖ 352 (35.2%) Unrelated artifacts (BOM, POM, ... or not recently updated)
