...
- 🧩 134 (13.4%) Java modules (module descriptor with stable name and API)
- ⬜ 211 (21.1%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 308 (30.8%) Automatic Java modules (name derived from JAR filename)
