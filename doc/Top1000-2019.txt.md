...
- 🧩 105 (10.5%) Java modules (module descriptor with stable name and API)
- ⬜ 205 (20.5%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 335 (33.5%) Automatic Java modules (name derived from JAR filename)
- ➖ 355 (35.5%) Unrelated artifacts (BOM, POM, ... or not recently updated)
...
| ⬜ | `org.jline.style` | `org.jline:jline` |
