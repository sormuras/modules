...
- 🧩 206 (20.6%) Java modules (module descriptor with stable name and API)
- ⬜ 288 (28.8%) Automatic Java modules (name derived from JAR manifest)
- ⚪ 384 (38.4%) Automatic Java modules (name derived from JAR filename)
- ➖ 122 (12.2%) Unrelated artifacts (BOM, POM, ... or not recently updated)
...
| 🧩 | `com.fasterxml.jackson.dataformat.cbor` | `net.snowflake:snowflake-ingest-sdk` |
