...
Collected 7,621 unique modules.
  automatic :cd: -> 5,328
  explicit :dvd: -> 2,293
...
- Naming is [_off_](http://blog.joda.org/2017/04/java-se-9-jpms-module-naming.html): [29612](suspicious/naming.md)
- Modular impostors: [10500](suspicious/impostors.md)
