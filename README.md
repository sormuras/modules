# sormuras/modules
Counted 7521 Java modules published at Maven Central

## Summary 2020-09-11T02:23:32.297910Z

```
## Summary

Started scan at 2020-09-11T02:23:32.297910Z
Scanned 60,923 files in 8 seconds.
   first -> modulescanner-report-2018_08_18_00_58_06.csv
    last -> modulescanner-report-2020_09_10_23_43_32.csv

Parsed 4,136,757 lines in total.
  64,611 -> captions skipped
  376,258 -> duplicates skipped
  208,250 -> module related

Collected 7,521 unique modules.
  automatic :cd: -> 5,334
  explicit :dvd: -> 2,187
...
## History
 ...
 - `2020_09={automatic=2542, explicit=448, plain=44049}` 	 6.79%
```
...
- Naming is [_off_](http://blog.joda.org/2017/04/java-se-9-jpms-module-naming.html): [28656](suspicious/naming.md)
- Modular impostors: [10070](suspicious/impostors.md)
