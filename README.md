# sormuras/modules
Counted 8150 Java modules published at Maven Central

## Summary 2020-12-16T03:39:03.926832Z

```
## Summary

Started scan at 2020-12-16T03:39:03.926832Z
Scanned 67,824 files in 8 seconds.
   first -> modulescanner-report-2018_08_18_00_58_06.csv
    last -> modulescanner-report-2020_12_16_03_22_08.csv

Parsed 4,760,989 lines in total.
  71,486 -> captions skipped
  448,105 -> duplicates skipped
  247,447 -> module related

Collected 8,150 unique modules.
  automatic :cd: -> 5,613
  explicit :dvd: -> 2,537
...
## History
 ...
 - `2020_12={automatic=4887, explicit=320, plain=83365}` 	 6.25%
```
...
- Invalid module names: [26479](suspicious/syntax.md)
- Naming is [_off_](http://blog.joda.org/2017/04/java-se-9-jpms-module-naming.html): [34443](suspicious/naming.md)
- Modular impostors: [12323](suspicious/impostors.md)
