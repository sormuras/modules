...
## Summary 2020-10-03T02:32:36.994616Z

```
## Summary

Started scan at 2020-10-03T02:32:36.994616Z
Scanned 62,554 files in 7 seconds.
   first -> modulescanner-report-2018_08_18_00_58_06.csv
    last -> modulescanner-report-2020_10_03_02_17_53.csv

Parsed 4,262,113 lines in total.
  66,234 -> captions skipped
  392,110 -> duplicates skipped
  217,321 -> module related
...
## History
 ...
 - `2020_10={automatic=674, explicit=162, plain=9222}` 	 9.07%
```
...
- Invalid module names: [23166](suspicious/syntax.md)
- Naming is [_off_](http://blog.joda.org/2017/04/java-se-9-jpms-module-naming.html): [29842](suspicious/naming.md)
- Modular impostors: [10639](suspicious/impostors.md)
