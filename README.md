...
- :dvd: `io.helidon.bundles.config` - `io.helidon.bundles:helidon-bundles-config:2.0.0-RC1`
- :dvd: `io.helidon.bundles.jersey` - `io.helidon.bundles:helidon-bundles-jersey:2.0.0-RC1`
- :dvd: `io.helidon.bundles.webserver` - `io.helidon.bundles:helidon-bundles-webserver:2.0.0-RC1`
- :dvd: `io.helidon.common` - `io.helidon.common:helidon-common:2.0.0-RC1`
- :dvd: `io.helidon.common.configurable` - `io.helidon.common:helidon-common-configurable:2.0.0-RC1`
- :dvd: `io.helidon.common.context` - `io.helidon.common:helidon-common-context:2.0.0-RC1`
- :dvd: `io.helidon.common.http` - `io.helidon.common:helidon-common-http:2.0.0-RC1`
- :dvd: `io.helidon.common.mapper` - `io.helidon.common:helidon-common-mapper:2.0.0-RC1`
- :dvd: `io.helidon.common.media.type` - `io.helidon.common:helidon-common-media-type:2.0.0-RC1`
- :dvd: `io.helidon.common.metrics` - `io.helidon.common:helidon-common-metrics:2.0.0-M3`
- :dvd: `io.helidon.common.pki` - `io.helidon.common:helidon-common-key-util:2.0.0-RC1`
- :dvd: `io.helidon.common.reactive` - `io.helidon.common:helidon-common-reactive:2.0.0-RC1`
- :dvd: `io.helidon.common.serviceloader` - `io.helidon.common:helidon-common-service-loader:2.0.0-RC1`
- :dvd: `io.helidon.config` - `io.helidon.config:helidon-config:2.0.0-RC1`
- :dvd: `io.helidon.config.bundle` - `io.helidon.config:helidon-config-bundle:0.10.6`
- :dvd: `io.helidon.config.encryption` - `io.helidon.config:helidon-config-encryption:2.0.0-RC1`
- :dvd: `io.helidon.config.etcd` - `io.helidon.config:helidon-config-etcd:2.0.0-RC1`
- :dvd: `io.helidon.config.git` - `io.helidon.config:helidon-config-git:2.0.0-RC1`
- :dvd: `io.helidon.config.hocon` - `io.helidon.config:helidon-config-hocon:2.0.0-RC1`
- :dvd: `io.helidon.config.mp` - `io.helidon.config:helidon-config-mp:2.0.0-RC1`
- :dvd: `io.helidon.config.objectmapping` - `io.helidon.config:helidon-config-object-mapping:2.0.0-RC1`
- :dvd: `io.helidon.config.test.infra` - `io.helidon.config:helidon-config-test-infrastructure:2.0.0-RC1`
- :dvd: `io.helidon.config.testing` - `io.helidon.config:helidon-config-testing:2.0.0-RC1`
- :dvd: `io.helidon.config.yaml` - `io.helidon.config:helidon-config-yaml:2.0.0-RC1`
- :dvd: `io.helidon.dbclient` - `io.helidon.dbclient:helidon-dbclient:2.0.0-RC1`
- :dvd: `io.helidon.dbclient.common` - `io.helidon.dbclient:helidon-dbclient-common:2.0.0-RC1`
- :dvd: `io.helidon.dbclient.health` - `io.helidon.dbclient:helidon-dbclient-health:2.0.0-RC1`
- :dvd: `io.helidon.dbclient.jdbc` - `io.helidon.dbclient:helidon-dbclient-jdbc:2.0.0-RC1`
- :dvd: `io.helidon.dbclient.jsonp` - `io.helidon.dbclient:helidon-dbclient-jsonp:2.0.0-RC1`
- :dvd: `io.helidon.dbclient.metrics` - `io.helidon.dbclient:helidon-dbclient-metrics:2.0.0-RC1`
- :dvd: `io.helidon.dbclient.metrics.jdbc` - `io.helidon.dbclient:helidon-dbclient-metrics-jdbc:2.0.0-RC1`
- :dvd: `io.helidon.dbclient.mongodb` - `io.helidon.dbclient:helidon-dbclient-mongodb:2.0.0-RC1`
- :dvd: `io.helidon.dbclient.tracing` - `io.helidon.dbclient:helidon-dbclient-tracing:2.0.0-RC1`
- :dvd: `io.helidon.dbclient.webserver.jsonp` - `io.helidon.dbclient:helidon-dbclient-webserver-jsonp:2.0.0-M3`
- :dvd: `io.helidon.grpc.client` - `io.helidon.grpc:helidon-grpc-client:2.0.0-RC1`
- :dvd: `io.helidon.grpc.core` - `io.helidon.grpc:helidon-grpc-core:2.0.0-RC1`
- :dvd: `io.helidon.grpc.metrics` - `io.helidon.grpc:helidon-grpc-metrics:2.0.0-RC1`
- :dvd: `io.helidon.grpc.server` - `io.helidon.grpc:helidon-grpc-server:2.0.0-RC1`
- :dvd: `io.helidon.health` - `io.helidon.health:helidon-health:2.0.0-RC1`
- :dvd: `io.helidon.health.checks` - `io.helidon.health:helidon-health-checks:2.0.0-RC1`
- :dvd: `io.helidon.health.common` - `io.helidon.health:helidon-health-common:2.0.0-RC1`
- :dvd: `io.helidon.integrations.cdi.delegates` - `io.helidon.integrations.cdi:helidon-integrations-cdi-delegates:2.0.0-RC1`
- :dvd: `io.helidon.integrations.cdi.eclipselink` - `io.helidon.integrations.cdi:helidon-integrations-cdi-eclipselink:2.0.0-RC1`
- :dvd: `io.helidon.integrations.cdi.hibernate` - `io.helidon.integrations.cdi:helidon-integrations-cdi-hibernate:2.0.0-RC1`
- :dvd: `io.helidon.integrations.cdi.jpa` - `io.helidon.integrations.cdi:helidon-integrations-cdi-jpa:2.0.0-RC1`
- :dvd: `io.helidon.integrations.cdi.jpa.weld` - `io.helidon.integrations.cdi:helidon-integrations-cdi-jpa-weld:2.0.0-M3`
- :dvd: `io.helidon.integrations.cdi.oci.objectstorage` - `io.helidon.integrations.cdi:helidon-integrations-cdi-oci-objectstorage:2.0.0-RC1`
- :dvd: `io.helidon.integrations.cdi.referencecountedcontext` - `io.helidon.integrations.cdi:helidon-integrations-cdi-reference-counted-context:2.0.0-RC1`
- :dvd: `io.helidon.jersey.client` - `io.helidon.jersey:helidon-jersey-client:2.0.0-RC1`
- :dvd: `io.helidon.jersey.common` - `io.helidon.jersey:helidon-jersey-common:2.0.0-RC1`
- :dvd: `io.helidon.jersey.media.jsonp` - `io.helidon.jersey:helidon-jersey-media-jsonp:2.0.0-RC1`
- :dvd: `io.helidon.jersey.server` - `io.helidon.jersey:helidon-jersey-server:2.0.0-RC1`
- :dvd: `io.helidon.media.common` - `io.helidon.media:helidon-media-common:2.0.0-RC1`
- :dvd: `io.helidon.media.jackson` - `io.helidon.media:helidon-media-jackson:2.0.0-RC1`
...
- :dvd: `io.helidon.media.jsonb` - `io.helidon.media:helidon-media-jsonb:2.0.0-RC1`
...
- :dvd: `io.helidon.media.jsonp` - `io.helidon.media:helidon-media-jsonp:2.0.0-RC1`
...
- :dvd: `io.helidon.media.multipart` - `io.helidon.media:helidon-media-multipart:2.0.0-RC1`
- :dvd: `io.helidon.messaging` - `io.helidon.messaging:helidon-messaging:2.0.0-RC1`
...
- :dvd: `io.helidon.metrics` - `io.helidon.metrics:helidon-metrics:2.0.0-RC1`
- :dvd: `io.helidon.metrics.prometheus` - `io.helidon.metrics:helidon-metrics-prometheus:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.accesslog` - `io.helidon.microprofile:helidon-microprofile-access-log:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.cdi` - `io.helidon.microprofile.cdi:helidon-microprofile-cdi:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.config` - `io.helidon.microprofile.config:helidon-microprofile-config:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.config.cdi` - `io.helidon.microprofile.config:helidon-microprofile-config-cdi:1.4.4`
- :dvd: `io.helidon.microprofile.cors` - `io.helidon.microprofile:helidon-microprofile-cors:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.faulttolerance` - `io.helidon.microprofile:helidon-microprofile-fault-tolerance:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.grpc.client` - `io.helidon.microprofile.grpc:helidon-microprofile-grpc-client:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.grpc.core` - `io.helidon.microprofile.grpc:helidon-microprofile-grpc-core:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.grpc.metrics` - `io.helidon.microprofile.grpc:helidon-microprofile-grpc-metrics:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.grpc.server` - `io.helidon.microprofile.grpc:helidon-microprofile-grpc-server:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.health` - `io.helidon.microprofile.health:helidon-microprofile-health:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.jwt.auth` - `io.helidon.microprofile.jwt:helidon-microprofile-jwt-auth:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.jwt.auth.cdi` - `io.helidon.microprofile.jwt:helidon-microprofile-jwt-auth-cdi:1.4.4`
- :dvd: `io.helidon.microprofile.messaging` - `io.helidon.microprofile.messaging:helidon-microprofile-messaging:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.metrics` - `io.helidon.microprofile.metrics:helidon-microprofile-metrics:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.oidc` - `io.helidon.microprofile:helidon-microprofile-oidc:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.openapi` - `io.helidon.microprofile.openapi:helidon-microprofile-openapi:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.restclient` - `io.helidon.microprofile.rest-client:helidon-microprofile-rest-client:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.security` - `io.helidon.microprofile:helidon-microprofile-security:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.server` - `io.helidon.microprofile.server:helidon-microprofile-server:2.0.0-RC1`
- :dvd: `io.helidon.microprofile.tracing` - `io.helidon.microprofile.tracing:helidon-microprofile-tracing:2.0.0-RC1`
- :dvd: `io.helidon.openapi` - `io.helidon.openapi:helidon-openapi:2.0.0-RC1`
- :dvd: `io.helidon.security` - `io.helidon.security:helidon-security:2.0.0-RC1`
...
- :dvd: `io.helidon.security.annotations` - `io.helidon.security:helidon-security-annotations:2.0.0-RC1`
...
- :dvd: `io.helidon.security.integration.common` - `io.helidon.security.integration:helidon-security-integration-common:2.0.0-RC1`
- :dvd: `io.helidon.security.integration.grpc` - `io.helidon.security.integration:helidon-security-integration-grpc:2.0.0-RC1`
- :dvd: `io.helidon.security.integration.jersey` - `io.helidon.security.integration:helidon-security-integration-jersey:2.0.0-RC1`
- :dvd: `io.helidon.security.integration.jersey.client` - `io.helidon.security.integration:helidon-security-integration-jersey-client:2.0.0-RC1`
- :dvd: `io.helidon.security.integration.webserver` - `io.helidon.security.integration:helidon-security-integration-webserver:2.0.0-RC1`
- :dvd: `io.helidon.security.jwt` - `io.helidon.security:helidon-security-jwt:2.0.0-RC1`
...
- :dvd: `io.helidon.security.providers.abac` - `io.helidon.security.providers:helidon-security-providers-abac:2.0.0-RC1`
- :dvd: `io.helidon.security.providers.common` - `io.helidon.security.providers:helidon-security-providers-common:2.0.0-RC1`
- :dvd: `io.helidon.security.providers.google.login` - `io.helidon.security.providers:helidon-security-providers-google-login:2.0.0-RC1`
- :dvd: `io.helidon.security.providers.header` - `io.helidon.security.providers:helidon-security-providers-header:2.0.0-RC1`
- :dvd: `io.helidon.security.providers.httpauth` - `io.helidon.security.providers:helidon-security-providers-http-auth:2.0.0-RC1`
- :dvd: `io.helidon.security.providers.httpsign` - `io.helidon.security.providers:helidon-security-providers-http-sign:2.0.0-RC1`
- :dvd: `io.helidon.security.providers.idcs.mapper` - `io.helidon.security.providers:helidon-security-providers-idcs-mapper:2.0.0-RC1`
- :dvd: `io.helidon.security.providers.jwt` - `io.helidon.security.providers:helidon-security-providers-jwt:2.0.0-RC1`
- :dvd: `io.helidon.security.providers.oidc` - `io.helidon.security.providers:helidon-security-providers-oidc:2.0.0-RC1`
- :dvd: `io.helidon.security.providers.oidc.common` - `io.helidon.security.providers:helidon-security-providers-oidc-common:2.0.0-RC1`
- :dvd: `io.helidon.security.tools.config` - `io.helidon.security:helidon-security-tools-config:0.10.6`
- :dvd: `io.helidon.security.util` - `io.helidon.security:helidon-security-util:2.0.0-RC1`
- :dvd: `io.helidon.tracing` - `io.helidon.tracing:helidon-tracing:2.0.0-RC1`
- :dvd: `io.helidon.tracing.config` - `io.helidon.tracing:helidon-tracing-config:2.0.0-RC1`
- :dvd: `io.helidon.tracing.jaeger` - `io.helidon.tracing:helidon-tracing-jaeger:2.0.0-RC1`
- :dvd: `io.helidon.tracing.jersey` - `io.helidon.tracing:helidon-tracing-jersey:2.0.0-RC1`
- :dvd: `io.helidon.tracing.jersey.client` - `io.helidon.tracing:helidon-tracing-jersey-client:2.0.0-RC1`
- :dvd: `io.helidon.tracing.tracerresolver` - `io.helidon.tracing:helidon-tracing-tracer-resolver:2.0.0-RC1`
- :dvd: `io.helidon.tracing.zipkin` - `io.helidon.tracing:helidon-tracing-zipkin:2.0.0-RC1`
- :dvd: `io.helidon.webclient` - `io.helidon.webclient:helidon-webclient:2.0.0-RC1`
- :dvd: `io.helidon.webclient.jaxrs` - `io.helidon.webclient:helidon-webclient-jaxrs:2.0.0-RC1`
- :dvd: `io.helidon.webclient.metrics` - `io.helidon.webclient:helidon-webclient-metrics:2.0.0-RC1`
- :dvd: `io.helidon.webclient.security` - `io.helidon.webclient:helidon-webclient-security:2.0.0-RC1`
- :dvd: `io.helidon.webclient.tracing` - `io.helidon.webclient:helidon-webclient-tracing:2.0.0-RC1`
- :dvd: `io.helidon.webserver` - `io.helidon.webserver:helidon-webserver:2.0.0-RC1`
- :dvd: `io.helidon.webserver.accesslog` - `io.helidon.webserver:helidon-webserver-access-log:2.0.0-RC1`
- :dvd: `io.helidon.webserver.cors` - `io.helidon.webserver:helidon-webserver-cors:2.0.0-RC1`
- :dvd: `io.helidon.webserver.jersey` - `io.helidon.webserver:helidon-webserver-jersey:2.0.0-RC1`
...
- :dvd: `io.helidon.webserver.test.support` - `io.helidon.webserver:helidon-webserver-test-support:2.0.0-RC1`
- :dvd: `io.helidon.webserver.tyrus` - `io.helidon.webserver:helidon-webserver-tyrus:2.0.0-RC1`
...
- :dvd: `org.meeuw.i18n.continents` - `org.meeuw.i18n:i18n-regions-continents:1.0.0`
- :dvd: `org.meeuw.i18n.countries` - `org.meeuw.i18n:i18n-regions-countries:1.0.0`
