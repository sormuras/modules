# sormuras/modules
Counted 7553 Java modules published at Maven Central

## Summary 2020-09-15T02:25:33.259798Z

```
## Summary

Started scan at 2020-09-15T02:25:33.259798Z
Scanned 61,238 files in 7 seconds.
   first -> modulescanner-report-2018_08_18_00_58_06.csv
    last -> modulescanner-report-2020_09_15_02_09_19.csv

Parsed 4,157,331 lines in total.
  64,926 -> captions skipped
  378,286 -> duplicates skipped
  210,237 -> module related

Collected 7,553 unique modules.
  automatic :cd: -> 5,341
  explicit :dvd: -> 2,212
...
## History
 ...
 - `2020_09={automatic=3616, explicit=595, plain=60293}` 	 6.98%
```
...
- Invalid module names: [22569](suspicious/syntax.md)
- Naming is [_off_](http://blog.joda.org/2017/04/java-se-9-jpms-module-naming.html): [28957](suspicious/naming.md)
- Modular impostors: [10161](suspicious/impostors.md)
