# sormuras/modules
Counted 7658 Java modules published at Maven Central

## Summary 2020-10-04T02:33:32.173124Z

```
## Summary

Started scan at 2020-10-04T02:33:32.173124Z
Scanned 62,634 files in 8 seconds.
   first -> modulescanner-report-2018_08_18_00_58_06.csv
    last -> modulescanner-report-2020_10_04_02_15_40.csv

Parsed 4,264,231 lines in total.
  66,314 -> captions skipped
  392,887 -> duplicates skipped
  217,388 -> module related

Collected 7,658 unique modules.
  automatic :cd: -> 5,355
  explicit :dvd: -> 2,303
...
## History
 ...
 - `2020_10={automatic=677, explicit=163, plain=10416}` 	 8.06%
```
...
- Invalid module names: [23167](suspicious/syntax.md)
- Naming is [_off_](http://blog.joda.org/2017/04/java-se-9-jpms-module-naming.html): [29886](suspicious/naming.md)
- Modular impostors: [10657](suspicious/impostors.md)
