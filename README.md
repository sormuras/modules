# sormuras/modules
Counted 7682 Java modules published at Maven Central

## Summary 2020-10-10T02:35:48.450394Z

```
## Summary

Started scan at 2020-10-10T02:35:48.450394Z
Scanned 63,057 files in 9 seconds.
   first -> modulescanner-report-2018_08_18_00_58_06.csv
    last -> modulescanner-report-2020_10_10_02_06_11.csv

Parsed 4,302,853 lines in total.
  66,736 -> captions skipped
  398,464 -> duplicates skipped
  220,599 -> module related

Collected 7,682 unique modules.
  automatic :cd: -> 5,366
  explicit :dvd: -> 2,316
...
## History
 ...
 - `2020_10={automatic=2591, explicit=267, plain=39828}` 	 7.18%
```
...
- Invalid module names: [23669](suspicious/syntax.md)
- Naming is [_off_](http://blog.joda.org/2017/04/java-se-9-jpms-module-naming.html): [30419](suspicious/naming.md)
- Modular impostors: [10815](suspicious/impostors.md)
